...
import 'package:course_tdd/infra/http/http.dart';
...
void main() {
  ...
  group('shared', () {
    test('Should thron serverError inf invalid method is provided', () async {
  ...
  group('post', () {
    ...
    test('Should return null if post returns 200 whith no data', () async {
